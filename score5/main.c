...
// неименованных POSIX семафоров расположенных в разделяемой памяти.
...
int main(int argc, char *argv[]) {
    ...
    printf("Many processes interact using UNNAMED POSIX semaphores located in shared memory.\n");
    ...
    // Работа с семафором
    {
        // ! Создаем НЕименованнный семафор для синхронизации процессов !
